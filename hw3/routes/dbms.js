...
var host = "35.230.78.255";    //from GCloud instance (change to match your db)
var database = "cheesecakedb";  //database name
var user = "root";         //username (change to match your db)
var password = "Cheesecakey1!";  //password (change to match your db, yes this is very poor practice)
